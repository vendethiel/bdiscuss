...
(function() {
  ...
  module.exports = JadeAngularJsCompiler = (function() {
    ...
    JadeAngularJsCompiler.prototype.writeModules = function(modules) {
      var content, moduleName, templates, writer,
        _this = this;
      ...
      for (moduleName in modules) {
        ...
        templates.map(function(e, i) {
          ...
          return content += "$templateCache.put('" + e.virtualPath + "', " + inlineContent + ");\n";
        });
        content += "}]);\n\n";
      }
      if (content) {
        writer = fileWriter(sysPath.join(this["public"], 'js', 'templates.js'));
